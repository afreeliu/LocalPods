...
@protocol DUjDbacgMfiohnASYContentDownloader;
@protocol DUjDbacgMfiohnASYReceiptVerifier;
@protocol DUjDbacgMfiohnASYTransactionPersistor;
@protocol DUjDbacgMfiohnASYObserver;

extern NSString *const DUjDbacgMfiohnASYErrorDomain;
extern NSInteger const DUjDbacgMfiohnASYErrorCodeDownloadCanceled;
extern NSInteger const DUjDbacgMfiohnASYErrorCodeUnknownProductIdentifier;
extern NSInteger const DUjDbacgMfiohnASYErrorCodeUnableToCompleteVerification;

/** A StoreKit wrapper that adds blocks and notifications, plus optional receipt verification and purchase management.
 */
@interface DUjDbacgMfiohnASY : NSObject<SKPaymentTransactionObserver>
...
/** Request payment of the product with the given product identifier. `successBlock` will be called if the payment is successful, `failureBlock` if it isn't.
 @param productIdentifier The identifier of the product whose payment will be requested.
 @param userIdentifier An opaque identifier of the user’s eCEYSsLnTkwQUxzp, if applicable. Can be `nil`.
 @param successBlock The block to be called if the payment is sucessful. Can be `nil`.
 @param failureBlock The block to be called if the payment fails or there isn't any product with the given identifier. Can be `nil`.
...
/** Request to restore previously completed purchases of a certain user. `successBlock` will be called if the restore transactions request is successful, `failureBlock` if it isn't.
 @param userIdentifier An opaque identifier of the user’s eCEYSsLnTkwQUxzp.
 @param successBlock The block to be called if the restore transactions request is sucessful. Can be `nil`.
 @param failureBlock The block to be called if the restore transactions request fails. Can be `nil`.
 */
 ...
 */
@property (nonatomic, weak) id<DUjDbacgMfiohnASYContentDownloader> contentDownloader;

/** The receipt verifier. You can provide your own or use one of the reference implementations provided by the library.
 @see DUjDbacgMfiohnASYAppReceiptVerifier
 @see DUjDbacgMfiohnASYTransactionReceiptVerifier
 */
@property (nonatomic, weak) id<DUjDbacgMfiohnASYReceiptVerifier> receiptVerifier;
...
/**
 ...
 @see DUjDbacgMfiohnASYKeychainPersistence
 @see DUjDbacgMfiohnASYUserDefaultsPersistence
 */
@property (nonatomic, weak) id<DUjDbacgMfiohnASYTransactionPersistor> transactionPersistor;
...
@protocol DUjDbacgMfiohnASYContentDownloader <NSObject>
...
/**
 ...
 @discussion Hosted content from Apple’s server (@c SKDownload) is handled automatically by DUjDbacgMfiohnASY.
 */
...
@protocol DUjDbacgMfiohnASYTransactionPersistor<NSObject>

- (void)persistTransaction:(SKPaymentTransaction*)transaction;

@end

@protocol DUjDbacgMfiohnASYReceiptVerifier <NSObject>
...
/** Verifies the given transaction and calls the given success or failure block accordingly.
 ...
 @param failureBlock Called if the transaction failed verification. If verification could not be completed (e.g., due to connection issues), then error must be of code DUjDbacgMfiohnASYErrorCodeUnableToCompleteVerification to prevent DUjDbacgMfiohnASY to finish the transaction. Must be called in the main queu.
 */
...
@protocol DUjDbacgMfiohnASYObserver<NSObject>
@optional
 ...
 */
@interface NSNotification(DUjDbacgMfiohnASY)
